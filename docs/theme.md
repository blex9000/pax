...
- `bg_panel_header`
  Header dei panel focused, selected workspace tab, collapsed panel chrome.
...
- Selected workspace tab / focused panel header / collapsed panel chrome
  ...
  - Rif: [`theme.rs`](/home/xb/dev/me/pax/crates/tp-gui/src/theme.rs#L731)
...
- bordo dei pannelli e dei collapsed panels derivato da `@headerbar_border_color`
